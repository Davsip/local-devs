                ...
                <ul className="navbar-nav mr-auto">
                  <li>
                    <div className="dropdown icon-tab ">
                      <button
                        className="btn btn-secondary dropdown-togglen text-nav "
                        type="button"
          ...
          <div className="container">
            ...
            <div className="row ">
              <div className="col-sm-5 col-md-4 col-lg-4">
                ...
                <br />
                <p className="text-justify">
                  The coding world has a big human part, and networking with
                  other developers is a fantastic way for making friends,
                  connections, learn, give advice. Check the calendar for
                  events!.
                </p>
              </div>
              <div className="col-md-5 col-lg-4 ">
              ...
              <div className="col-md-5 col-lg-4">
                ...
                <p className="text-justify">
                  ...
                  organize different activities for recreation.
                </p>
              </div>
            </div>
          </div>
